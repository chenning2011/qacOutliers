...
```{r}
multiOutliers(mtcarsOutliers, method = "mahalanobis", alpha = alpha)
```
...
3. Dependencies: The function uses the `Routliers` package, so ensure it is installed before running this method.
