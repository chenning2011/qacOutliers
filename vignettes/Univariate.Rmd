...
Univariate outliers are data points consisting of an extreme value for one variable. These values lie far from the dataset's central tendency. This package detects univariate outliers using three methods: Box Plot Method, Grubbs' Test Method, and Median Absolute Deviation (MAD) Method.
